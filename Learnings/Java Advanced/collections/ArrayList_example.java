...
public class ArrayList_example{
	...
	static void arrayListDemo2(){
		...
		//System.out.println("Removing last element: "  + v2.remove(100)); got index 100 out of bounds exception
		System.out.println("Removing last element: "  + v2.remove(99));
		System.out.println("now Size of v2 is : "  + v2.size());
		Integer arr[] = new Integer[100];
		arr = (Integer[]) v2.toArray();
		System.out.println(arr);

	}

	static void arrayListDemo3(){
		...
		// System.out.println("Size of v2 is : "  + v2.size());
		Integer arr[] = new Integer[100];
		arr = (Integer[]) v2.toArray(arr);
		//System.out.println(arr); some junk value
		for(int i: arr)
		{
			System.out.println(i);
		}
